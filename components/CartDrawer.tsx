...
export function CartDrawer() {
    ...
    return (
        <>
            ...
            {/* Drawer */}
            <div
                className={`fixed top-0 drawer-card right-0 h-full w-full max-w-[350px] bg-white z-[1000] shadow-2xl flex flex-col transition-transform duration-300 ease-in-out ${
