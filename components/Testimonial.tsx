...
import { fetchMappedTestimonials, type MappedTestimonial } from "@/lib/api/testimonial";
...
function SkeletonCard() {
    return (
        <div
            className="card"
            style={{ padding: "36px", height: "100%", display: "flex", flexDirection: "column", gap: "12px" }}
        >
            {/* Stars */}
            ...
            {[95, 80, 88, 65].map((w) => (
                <div
                    key={w}
                    style={{
                        height: "14px", width: `${w}%`, borderRadius: "3px",
            ...
            <div style={{ display: "flex", alignItems: "center", gap: "10px" }}>
                ...
                <div style={{ display: "flex", flexDirection: "column", gap: "6px" }}>
                    <div style={{ width: "100px", height: "12px", borderRadius: "3px", background: "rgba(255,255,255,0.06)", animation: "shimmer 1.5s ease-in-out infinite" }} />
                    <div style={{ width: "130px", height: "10px", borderRadius: "3px", background: "rgba(255,255,255,0.04)", animation: "shimmer 1.5s ease-in-out infinite 0.1s" }} />
                </div>
            </div>
        </div>
    );
    ...
    return (
        <div
            style={{
                ...
                fontSize: "11px", fontWeight: 700, color: t.color, letterSpacing: "0.04em",
            }}
        >
            {showImg ? (
                <Image
...
function TestimonialCard({ t, i }: { t: MappedTestimonial; i: number }) {
    return (
        <AnimatedSection delay={i * 0.1}>
            <div className="card" style={{ padding: "36px", height: "100%", display: "flex", flexDirection: "column" }}>
                {/* Stars */}
