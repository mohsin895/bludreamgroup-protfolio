...
import { Menu, Search, Heart, User, X, ChevronDown, ShoppingCart, Plus, Minus } from "lucide-react"
        ...
        <>
            ...
            >
                <div className="container">
                    <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", height: scrolled ? "64px" : "80px", transition: "height 0.4s ease" }}>
                        {/* Logo */}
                        <Link
                            href="/"
                            style={{
                        ...
                        >
                            <span style={{ color: "var(--gold)" }}>{setting?.site_name ?? "Blue dream"}</span>
                        </Link>

                        {/* Desktop Nav */}
                        <div ref={dropdownRef} style={{ display: "flex", alignItems: "center", gap: "2px" }} className="desktop-nav">
                            {primaryNav.map((item) => (
                                    ...
                                    {item.children ? (
                                        <button
                                            ...
                                            style={{
                                                ...
                                                color: activeDropdown === item.label ? "var(--gold)" : "var(--text-muted)",
                                        ...
                                        <Link
                                            ...
                                            onMouseEnter={(e) => {
                                                if (pathname !== item.href) (e.target as HTMLElement).style.color = "var(--text)";
                                            }}
                                            onMouseLeave={(e) => {
                                                if (pathname !== item.href) (e.target as HTMLElement).style.color = "var(--text-muted)";
                                            }}
                                        >
                                            {item.label}
                                        </Link>
                            ...
                            <button
                                ...
                                className="relative flex items-center gap-2 cursor-pointer text-sm text-gray-700 hover:text-red-600 transition-colors"
                            ...
                            <Link href="/contact" className="btn-primary" style={{ marginLeft: "16px", fontSize: "12px", padding: "10px 24px" }}>
                                Work With Me
                            </Link>
                        </div>
                ...
                {/* Gold line at bottom */}
                <div style={{ height: "1px", background: "linear-gradient(90deg, transparent, var(--gold), transparent)", opacity: solidNav ? 0 : 0.3 }} />
            </nav>
                                ...
                                {item.children ? (
                                    <>
                                        <div
                                            style={{
                                                ...
                                                animation: mobileOpen ? `fadeIn 0.4s ${i * 0.05}s both` : "none",
                                            }}
                                        >
                                            {item.label}
                                        </div>
                                    ...
                                    <Link
                                        ...
                                        style={{
                                            ...
                                            textDecoration: "none",
                                            borderBottom: "1px solid rgba(255,255,255,0.04)",
                                            animation: mobileOpen ? `slideIn 0.4s ${i * 0.05}s both` : "none",
                                        }}
                                    >
                                        {item.label}
                                    </Link>
