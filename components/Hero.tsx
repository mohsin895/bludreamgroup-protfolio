            ...
            <section style={styles.root}>
                <div style={styles.skeleton}>
                    ...
                    <div style={styles.skeletonLines}>
                        ...
                        <div style={{ ...styles.skeletonLine, width: "40%", height: "48px", marginTop: "16px" }} />
                        <div style={{ ...styles.skeletonLine, width: "80%", height: "20px", marginTop: "20px" }} />
                    </div>
                </div>
                    ...
                    <div style={styles.textBlock}>
                        <div
                            style={{
                                ...
                                transform: textVisible ? "translateY(0) skewX(0deg)" : "translateY(12px) skewX(-3deg)",
                            ...
                            {slide.title.split(" ").map((word, wi) => (
                                <span
                                    ...
                                    style={{
                                        ...
                                        marginRight: "0.3em",
                                        opacity: textVisible ? 1 : 0,
                                        transform: textVisible ? "translateY(0) rotateX(0deg)" : "translateY(40px) rotateX(15deg)",
                                        transition: `opacity 0.7s ease ${0.1 + wi * 0.07}s, transform 0.7s cubic-bezier(0.16,1,0.3,1) ${0.1 + wi * 0.07}s`,
                                    }}
                                >
                  {word}
                </span>
                        ...
                        >
                            {slide.url ? (
                                <Link href={slide.url} style={styles.btnPrimary}>
                                    Discover More <ArrowRight size={15} />
                                </Link>
                            ) : (
                                <Link href="/about" style={styles.btnPrimary}>
                                    Discover More <ArrowRight size={15} />
                                </Link>
                            )}
                        </div>
                    ...
                    <div style={styles.bottomBar}>
                            ...
                            {slides.map((_, i) => (
                                <button
                                    ...
                                    style={{
                                        ...
                                        background: i === current ? "#82c3d8" : "rgba(255,255,255,0.3)",
                        ...
                        <div style={styles.controls}>
                            ...
                            <button style={styles.controlBtn} onClick={goPrev} aria-label="Previous slide">
                                <ChevronLeft size={18} />
                            </button>
                            <button style={styles.controlBtn} onClick={next} aria-label="Next slide">
                        ...
                        return (
                            <button
                                ...
                                style={{
                                    ...
                                    border: i === current ? "2px solid #82c3d8" : "2px solid transparent",
                            ...
                            >
                                {s.media_type === "video" && s.video ? (
                                    ...
                                    <div style={{ ...styles.thumbnailMedia, background: "#203647" }} />
                                )}
...
const styles: Record<string, React.CSSProperties> = {
    ...
    fallbackBg: {
        width: "100%",
        height: "100%",
        background: "linear-gradient(135deg,#0d1f2d 0%,#091318 100%)",
    },
    overlayBottom: {
        position: "absolute",
        inset: 0,
    ...
    progressBar: {
        height: "100%",
        background: "linear-gradient(90deg, #82c3d8, #b8dde8)",
    ...
    skeletonGlow: {
        ...
        width: "300px",
        height: "300px",
        background: "radial-gradient(circle, rgba(130,195,216,0.06) 0%, transparent 70%)",
        borderRadius: "50%",
