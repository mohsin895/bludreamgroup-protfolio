  ...
  return (
    ...
    >
      ...
      >
        <button
          onClick={() =>
            dispatch(updateQuantity({ cartKey, quantity: quantity - 1 }))
          }
          disabled={quantity <= 1}
          style={{
            width: "32px",
      ...
      <button
        ...
        onMouseEnter={(e) => {
          (e.currentTarget as HTMLElement).style.color = "#C47C5A";
          (e.currentTarget as HTMLElement).style.borderColor = "#C47C5A44";
        }}
        onMouseLeave={(e) => {
                  ...
                  >
                    ...
                    >
                      ...
                      <span
                        style={{
                          fontWeight: 600,
                          color: shipping === 0 ? "#7C9A7E" : "var(--text)",
                        }}
                      >
