...
const CATEGORIES = ["All", "Guide", "Template", "Checklist", "Worksheet", "Video"] as const;
    ...
    return (
        ...
        >
            ...
            <div style={{ padding: "28px", display: "flex", flexDirection: "column", gap: "12px" }}>
                <div style={{ width: "42px", height: "42px", borderRadius: "50%", background: "#1a1a1a" }} />
                <div style={{ height: "18px", width: "75%", background: "#1a1a1a", borderRadius: "4px" }} />
                <div style={{ height: "60px", width: "100%", background: "#161616", borderRadius: "4px" }} />
                <div style={{ display: "flex", gap: "6px" }}>
                    {[60, 50, 40].map((w) => (
                        <div key={w} style={{ height: "18px", width: `${w}px`, background: "#161616", borderRadius: "4px" }} />
                    ))}
                </div>
            </div>
        </div>
        ...
        <>
            ...
            >
                ...
                do the work.
                        ...
                        >
                            Free guides, templates, checklists, and worksheets built for authors, designers, and
                            publishers — no fluff, only what works.
                        </p>
            ...
            >
                <div className="container">
                    ...
                    >
                        {[
                            { value: loading ? "…" : String(allResources.length), label: "Free Resources" },
                ...
                <div className="container">
                                ...
                                {CATEGORIES.map((cat) => (
                                    <button
                                        ...
                                        style={{
                                            ...
                                            fontSize: "12px",
                                            letterSpacing: "0.06em",
                                            background: activeType === cat ? "rgba(201,168,76,0.12)" : "transparent",
                                            border: `1px solid ${activeType === cat ? "rgba(201,168,76,0.35)" : "rgba(255,255,255,0.08)"}`,
                                            borderRadius: "100px",
                                            color: activeType === cat ? "var(--gold)" : "rgba(255,255,255,0.4)",
                                            cursor: "pointer",
                    ...
                    {loading ? (
                        ...
                        <div style={{ textAlign: "center", padding: "80px 20px", color: "rgba(255,255,255,0.2)" }}>
                            <p style={{ fontSize: "16px" }}>No resources found for &quot;{activeType}&quot;</p>
                        </div>
                    ) : (
                        <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fill,minmax(300px,1fr))", gap: "20px" }}>
                ...
                <div className="container">
                    <AnimatedSection>
                        <div style={{ maxWidth: "560px", margin: "0 auto" }}>
                            ...
                            >
                                We publish new guides, templates, and tools every month. Subscribe and we'll send
                                them straight to your inbox — no noise, no upsells.
                            </p>
                            <div
                                style={{
                                    display: "flex",
