...
import {
    ...
    Clock, XCircle, Loader2, Eye,
    RefreshCw,
} from "lucide-react"
import AnimatedSection from "@/components/AnimatedSection"
import Navbar from "@/components/Navbar"
import Footer from "@/components/Footer"
import { orderApi, formatPrice, type Order } from "@/lib/api/orderApi"
        ...
        <>
            ...
            <section style={{ paddingTop: "120px", paddingBottom: "48px", background: "var(--bg)", borderBottom: "1px solid rgba(255,255,255,0.05)" }}>
                <div className="container">
                    <AnimatedSection>
                        <h1 style={{ fontFamily: "var(--font-display)", fontSize: "clamp(32px, 4vw, 54px)", lineHeight: 1, marginBottom: "12px" }}>
                            Your Orders
                        </h1>
                    ...
                    {orders.length === 0 ? (
                        <AnimatedSection>
                            <div style={{
                                ...
                                <Package size={40} style={{ color: "var(--text-muted)", margin: "0 auto 16px" }} />
        ...
        <Link href={`/orders/${order.id}`} style={{ textDecoration: "none" }}>
            ...
            >
                ...
                <div style={{ padding: "20px", borderBottom: "1px solid rgba(255,255,255,0.06)" }}>
                    <div style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-start", marginBottom: "12px" }}>
                        <div>
                            ...
                            <p style={{ fontSize: "13px", color: "var(--text-muted)" }}>{date}</p>
                        </div>
                        <div style={{
                            display: "inline-flex",
                            alignItems: "center",
                ...
                <div style={{ padding: "16px 20px", flex: 1, minHeight: "120px" }}>
                    <p style={{ fontSize: "12px", color: "var(--text-dim)", marginBottom: "12px", textTransform: "uppercase", letterSpacing: "0.06em" }}>
                        Items ({itemCount})
                    </p>
                        ...
                        {(order.items ?? []).slice(0, 3).map((item, idx) => (
                            ...
                            >
                                {item.image ? (
                                    ...
                                    <Package size={16} style={{ color: "rgba(255,255,255,0.1)" }} />
                                )}
                            </div>
                        ))}
                        {itemCount > 3 && (
                ...
                <div style={{ padding: "16px 20px", borderTop: "1px solid rgba(255,255,255,0.06)", display: "flex", justifyContent: "space-between", alignItems: "center" }}>
                    <div>
                        <p style={{ fontSize: "11px", color: "var(--text-dim)", marginBottom: "4px", textTransform: "uppercase", letterSpacing: "0.06em" }}>Total</p>
