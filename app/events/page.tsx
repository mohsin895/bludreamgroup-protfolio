    ...
    return (
        ...
        >
            <div style={{ display: "flex", gap: "20px" }}>
                <div style={{ width: "56px", height: "76px", borderRadius: "6px", background: "rgba(255,255,255,0.06)", animation: "shimmer 1.5s ease-in-out infinite" }} />
                <div style={{ flex: 1, display: "flex", flexDirection: "column", gap: "10px" }}>
                    <div style={{ height: "14px", width: "40%", borderRadius: "3px", background: "rgba(255,255,255,0.06)", animation: "shimmer 1.5s ease-in-out infinite" }} />
                    <div style={{ height: "16px", width: "85%", borderRadius: "3px", background: "rgba(255,255,255,0.06)", animation: "shimmer 1.5s ease-in-out infinite 0.1s" }} />
                    <div style={{ height: "12px", width: "60%", borderRadius: "3px", background: "rgba(255,255,255,0.06)", animation: "shimmer 1.5s ease-in-out infinite 0.2s" }} />
                </div>
            </div>
            <div style={{ marginTop: "18px", height: "40px", borderRadius: "3px", background: "rgba(255,255,255,0.04)", animation: "shimmer 1.5s ease-in-out infinite 0.3s" }} />
        </div>
    );
}
...
function ErrorState({ message, onRetry }: { message: string; onRetry: () => void }) {
    return (
        <div style={{ textAlign: "center", padding: "80px 0" }}>
            <AlertCircle size={40} style={{ color: "#C47C5A", marginBottom: "16px", opacity: 0.7 }} />
            <p style={{ color: "rgba(255,255,255,0.4)", fontSize: "15px", margin: "0 0 24px" }}>{message}</p>
            <button
                onClick={onRetry}
                style={{
                    padding: "10px 24px",
            ...
            >
                ...
                >
                  {TYPE_LABELS[event.type] ?? event.categoryTitle}
                    ...
                    {/* Description */}
                    <p style={{ fontSize: "13px", lineHeight: 1.75, color: "rgba(255,255,255,0.4)", margin: "18px 0 0" }}>
                        {event.description}
                    </p>
...
export default function EventsPage() {
    ...
    const activeCategories = categories.filter((cat) =>
        events.some((e) => e.categoryTitle.toLowerCase() === cat.title.toLowerCase())
    );
                ...
                <div className="container">
                    <AnimatedSection>
                        ...
                        <div style={{ display: "flex", gap: "40px", marginTop: "40px", flexWrap: "wrap" }}>
                            {[
                                { label: "Upcoming Events", value: loading ? "—" : upcomingCount },
                                { label: "Past Events",     value: loading ? "—" : pastCount     },
                                { label: "Event Types",     value: loading ? "—" : activeCategories.length },
                            ].map((s) => (
                                <div key={s.label}>
                                    <div
                                        style={{
                ...
                <div className="container">
                    ...
                    <span style={{ display: "flex", alignItems: "center", gap: "6px", fontSize: "13px", color: "rgba(255,255,255,0.45)" }}>
                      ...
                      <MapPin size={12} style={{ color: "var(--gold, #C9A84C)" }} />
                                        ...
                                        <span style={{ display: "flex", alignItems: "center", gap: "6px", fontSize: "13px", color: "rgba(255,255,255,0.45)" }}>
                      <Clock size={12} style={{ color: "var(--gold, #C9A84C)" }} />
                                            {featured.time}
                    </span>
                                    </div>
                                </div>
                                    ...
                                    {(
                                        ...
                                        <button
                                            ...
                                            style={{
                                                ...
                                                color:      activeTab === tab.key ? "var(--gold, #C9A84C)" : "rgba(255,255,255,0.35)",
                                                fontSize: "12px",
                                                letterSpacing: "0.05em",
                                                cursor: "pointer",
                                ...
                                <div style={{ display: "flex", flexWrap: "wrap", gap: "6px" }}>
                                    ...
                                    <button
                                        ...
                                        style={{
                                            ...
                                            borderRadius: "100px",
                                            border: "1px solid",
                                            borderColor: activeType === "all" ? "var(--gold, #C9A84C)" : "rgba(255,255,255,0.08)",
                                            background:  activeType === "all" ? "rgba(201,168,76,0.1)" : "transparent",
                                            color:       activeType === "all" ? "var(--gold, #C9A84C)" : "rgba(255,255,255,0.3)",
                                            fontSize: "11px",
                                            letterSpacing: "0.08em",
                                            cursor: "pointer",
                                            transition: "all 0.2s ease",
                                    ...
                                    {activeCategories.map((cat) => {
                                        ...
                                        const color   = TYPE_COLORS[typeKey] ?? "var(--gold, #C9A84C)";
                    ...
                    {loading && (
                        <div style={{ display: "flex", justifyContent: "center", marginTop: "40px", color: "rgba(255,255,255,0.2)" }}>
                        ...
                        <AnimatedSection delay={0.3}>
                            ...
                            >
                                <div>
                                    ...
                                    >
                                        New events are announced first via the newsletter. Subscribers also get
                                        early access to limited workshop spots and signed editions.
                                    </p>
                                </div>
