            ...
            >
                <div className="container">
                    <AnimatedSection>
                        ...
                        >
                            Photographs, interviews, press coverage, and event
                            highlights. Click any card to expand and explore.
                        </p>
                    ...
                    {loading ? (
                        ...
                        >
                            ...
                            {activeFilter !== "all"
                                ? ` ${activeFilter}`
                                : ""}{" "}
                            items found. Try another filter.
                        </div>
                    ) : (
                        <div style={{ columns: "3 280px", columnGap: 24 }}>
                    ...
                    <AnimatedSection delay={0.4}>
                        <div
                            style={{
                                ...
                                padding: "56px 52px",
                                background:
                                    "linear-gradient(135deg, rgba(201,168,76,0.05) 0%, rgba(0,0,0,0.2) 100%)",
                        ...
                        >
                            <div>
                                ...
                                >
                                    High-resolution photos, press kit,
                                    interview requests, and event
