...
function normalizeApiCourse(apiCourse: ApiCourse, index: number): NormalizedCourse {
    ...
    return {
        ...
        /* selling price */
        price: hasDiscount ? `$${rawDiscount!.toFixed(2)}` : `$${rawPrice.toFixed(2)}`,
                ...
                <div>
                    ...
                    >
                        {(
                            ...
                            >
                                <span style={{ color: "var(--gold)", fontSize: "11px" }}>
                                    {m.icon}
                                </span>
                                {m.label}
                            </span>
                        ...
                        <Link
                            ...
                            style={{
                                ...
                                background: hovered
                                    ...
                                    : "rgba(201,168,76,0.1)",
                                border: `1px solid ${
                                    hovered ? "var(--gold)" : "rgba(201,168,76,0.2)"
                                }`,
                                borderRadius: "5px",
                                fontSize: "11px",
                                fontWeight: 700,
...
export default function CoursesPage(): ReactNode {
    ...
    const levels: string[] = ["All Levels", "Beginner", "Intermediate", "Advanced"];
    ...
    return (
        <>
            ...
            {!loading && featured && (
                <section
                    style={{ background: "#0a0a0a", paddingTop: "80px", paddingBottom: "0" }}
                >
                    <div className="container">
                        ...
                        <AnimatedSection>
                            <div style={{ maxWidth: "580px", margin: "0 auto" }}>
                                ...
                                >
                                    ...
                                    professional? Apply to teach on the platform and reach thousands
                                    of ambitious creators.
                                </p>
                                <div
                                    style={{
                                        display: "flex",
